    ...
    <ul style="margin:0; padding:0; list-style-type:none;">
      ${products.map((p) => `
        <li style="${textStyle} padding:4px 0; display:flex; align-items:center;">
          <span style="${diamondStyle}">✦</span> ${p}
        </li>
      `).join("")}
    </ul>`;
}
          ...
          <tr>
            <td align="center" style="padding:32px 16px;">
              ...
              <table
                ...
                border="0"
                role="presentation"
                style="max-width:580px;width:100%;background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;">
          ...
          <tr>
            <td align="center" style="padding:32px 16px;">
              ...
              <!-- YOUR EMAIL CONTENT STARTS HERE -->
                ...
                <!-- ④ Submission Summary -->
                <tr>
                <td style="padding:32px 36px 0 36px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;">
                  <p style="margin:0 0 20px 0; font-size:11px; font-weight:800; letter-spacing:2px; text-transform:uppercase; color:#4338ca;">
                    Submission Summary
                  </p>
                    ...
                    <tr>
                      <td style="padding-bottom: 12px;">
                        <div style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px; padding:16px 20px;">
                          ...
                          <span style="font-size:15px; color:#1e293b; font-weight:700;">${company}</span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding-bottom: 12px;">
                        <div style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px; padding:16px 20px;">
                          <span style="font-size:10px; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:1px; display:block; margin-bottom:4px;">Industry</span>
                          <span style="font-size:15px; color:#1e293b; font-weight:700;">${industry || "Not specified"}</span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border: 1px solid #e2e8f0; border-left: 4px solid #4338ca; border-radius: 12px; padding: 18px 20px;">
                          <span style="font-size:10px; font-weight:700; color:#4338ca; text-transform:uppercase; letter-spacing:1px; display:block; margin-bottom:12px;">Interested Products</span>
                          ${productHtml}
                        </div>
                      </td>
                    </tr>
